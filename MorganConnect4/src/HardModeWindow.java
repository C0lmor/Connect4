...
public class HardModeWindow extends javax.swing.JFrame {
...
// arrays to find the winner
    ...
    public void turns() { // this method will make the decision for the computer
        if (won == false) {
            boolean choice = false; // this varaible is used to make it so that the computer only acts once per turn
            turn = 2;
            int r = 0; // sets color so that the difference between players can be seen
            int b = 255;
            for (int row = 0; row < winner.length; row++) {
                for (int col = 0; col < winner[row].length - 2; col++) {
                    if (choice == false) {
                        if (winner[row][col] == 1 && winner[row][col + 1] == 1 && winner[row][col + 2] == 0) {
                            // if the user is trying to get 4 in a row through the horizontal axis the computer will play a chip to block them off
                            if (col + 2 == 2) { // for example if the empty column is column 3
                                column3(r, b); // the computer will play a chip in column three
                                choice = true;
                            } else if (col + 2 == 3) {
                                column4(r, b);
                                choice = true;
            ...
            if (choice == false) { // if a choice was made above then the computer wont act again
                for (int row = 0; row < winner.length; row++) {
                    for (int col = 2; col < winner[row].length; col++) {
                        if (choice == false) {
                            if (winner[row][col] == 1 && winner[row][col - 1] == 1 && winner[row][col - 2] == 0) {
                                // this choice also acts upon horizontal pieces but places them on the left instead of the right
                                if (col - 2 == 0) { // if the column to the left that is empty is column 1
                                    column1(r, b); // the computer plays a chip there
                                    choice = true;
                                } else if (col - 2 == 1) {
                                    column2(r, b);
                                    choice = true;
            ...
            if (choice == false) {
                for (int row = 0; row < winner.length - 2; row++) {
                    for (int col = 0; col < winner[row].length; col++) {
                        if (choice == false) {
                            if (winner[row][col] == 1 && winner[row + 1][col] == 1 && winner[row + 2][col] == 0) {
                                //if the user is trying to stack chips vertically
                                if (col == 0) { // the computer detects the column
                                    column1(r, b); // plays a chip there
                                    choice = true;
                                } else if (col == 1) {
                                    column2(r, b);
                                    choice = true;
            ...
            if (choice == false) {
                for (int row = 0; row < winner.length - 2; row++) {
                    for (int col = 0; col < winner[row].length - 2; col++) {
                        if (choice == false) {
                            if (winner[row][col] == 1 && winner[row + 1][col + 1] == 1 && winner[row + 2][col + 2] == 0) {
                                // if the user is trying to stack chips diagonally and the computer can play a chip there to block them off
                                if (col + 2 == 2) { // if the column that is empty is column 2
                                    if (col3 == row + 2) { // and there is enough chips in it already to block off the user the computer does that
                                        column3(r, b);
                                        choice = true;
                                    }
                                } else if (col + 2 == 3) {
            ...
            if (choice == false) {
                for (int row = 2; row < winner.length; row++) {
                    for (int col = 0; col < winner[row].length - 2; col++) {
                        if (choice == false) {
                            if (winner[row][col] == 1 && winner[row - 1][col + 1] == 1 && winner[row - 2][col + 2] == 0) {
                                //this is the choice for downwards diagonals
                                if (col + 2 == 2) { // detects the empty column
                                    if (col3 == row - 2) { // if the empty column has no chip in the row that can be used to block off the user the computer
                                        column3(r, b); // plays a chip in that column
                                        choice = true;
                                    }
                                } else if (col + 2 == 3) {
                                    if (col4 == row - 2) {
            ...
            if (choice == false) { // if no other choice has been made the computer instead uses a random numbe generated to choose a random column
    ...
    public HardModeWindow(Connect4 m) {
        initComponents();
    ...
    private void initComponents() {
        ...
        connect4Grid.setBackground(java.awt.Color.black);
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(txtOutput, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnColumn2, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                    .addComponent(btnColumn3, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                    .addComponent(btnColumn4, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                    .addComponent(btnColumn5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                    .addComponent(btnColumn6, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE)
                    .addComponent(btnColumn7, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btnColumn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColumn2ActionPerformed
        ...
        column2(r, b); // calling the methid
    ...
    private void btnColumn1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColumn1ActionPerformed
        ...
        column1(r, b); // calling the methid
    ...
    private void btnColumn3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColumn3ActionPerformed
        ...
        column3(r, b); // calling the methid
    ...
    private void btnColumn4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColumn4ActionPerformed
        ...
        column4(r, b); // calling the methid
    ...
    private void btnColumn5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColumn5ActionPerformed
        ...
        column5(r, b); // calling the methid
    ...
    private void btnColumn6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnColumn6ActionPerformed
        ...
        column6(r, b); // calling the methid
    ...
    private void btnResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnResetActionPerformed
        ...
        for (int row = 0; row < winner.length; row++) {
            for (int col = 0; col < winner[row].length; col++) {
                winner[row][col] = 0; // a loop that will change all varaibles in the winner array to a meaningless number so that the game wont be won instnatly
            }
        }
